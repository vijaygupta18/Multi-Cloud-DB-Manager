-- ============================================
-- Migration 002: Add CKH_MANAGER role
-- Adds CKH_MANAGER to the users.role CHECK constraint.
-- Idempotent and constraint-name-agnostic: discovers the existing CHECK
-- on the role column at runtime so it works regardless of how 001 named it.
-- ============================================
...
ALTER TABLE dual_db_manager.users
  ...
  CHECK (role IN ('MASTER', 'USER', 'READER', 'CKH_MANAGER'));
